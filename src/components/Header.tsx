    ...
    <StyledHeader>
      <Navbar expand="lg">
        <Container>
          ...
          <Navbar.Toggle />
          <Navbar.Collapse>
            <Nav className="m-auto my-2 d-flex justify-around w-100      my-lg-0" style={{ maxHeight: "460px" }}>
              ...
              <Nav.Link href="#action2">For driver</Nav.Link>
              <Nav.Link href="#action2">For carrier</Nav.Link>
              <Nav.Link href="#action2">For recruiter</Nav.Link>
            </Nav>
