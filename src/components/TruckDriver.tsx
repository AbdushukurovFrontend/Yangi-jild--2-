  ...
  return (
    <StyledTruckPage>
      ...
      <div className="container-fluid">
        <div className="row ">
          <div className="col-12 col-xxl-6 col-xl-6 col-lg-8 col-md-8 col-sm-12 mt-xl-2 d-none d-sm-block mt-5">
      ...
      <div className="container">
        <div className="row mt-5">
          <div className="col-12 col-xxl-5 col-xl-6 col-lg-6 col-md-10 col-sm-10 mt-5  nest ">
            <div className="">
              <div className=" p-4   p1 position-relative  ">
                <div className="">
                <p className="text-white  card_subtitle ">
                  ‘’WE HAVE A FANTASTIC TRACK RECORD IN SECURING LOGISTICS
                  TALENT,REPRESENTING GLOBAL BRANDS AND ADVISING ON RECRUITMENT
                  STRATEGIES.WITH AN INNATE UNDERSTANDING OF THE DYNAMIC
                  CHALLENGES FACING THE SECTOR,WE HAVE THE CAPABILITIES TO FIND
                  PROFESSIONAL AND MANAGERIAL-LEVEL CANDIDATES FOR YOUR
                  BUSINESS.WE ENSURE THAT THESE CANDIDATES HAVE THE RELEVANT
                  SKILLS TO FULFIL THE DEVELOPING DEMANDS OF THE MARKET, FROM
                  STRATEGIC MANAGEMENT TO CUSTOMER SERVICE. ,,
                </p>
                </div>
      ...
      <section className=" mt-4">
        <div className="container">
          <div className="row ">
            ...
            <div className="col-5 offset-xxl-3 offset-xl-3 offset-lg-2 offset-md-1 offset-sm-0">
              <h2>
                <span className="last m2">YOUR</span>
              </h2>
            </div>
            <div className="col-8 offset-xxl-4 offset-xl-4 offset-lg-3 offset-md-2 offset-sm-0 ">
